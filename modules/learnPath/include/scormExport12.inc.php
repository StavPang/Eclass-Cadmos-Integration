...
';
        ...
        function prepare() {
            ...
            if (
                    !claro_copy_file('modules/learnPath/export12/APIWrapper.js', $this->destDir) || !claro_copy_file('template/modern/css/bootstrap.min.css', $this->destDir) || !claro_copy_file('modules/learnPath/export12/scores.js', $this->destDir) || !claro_copy_file('modules/learnPath/export12/ims_xml.xsd', $this->destDir) || !claro_copy_file('modules/learnPath/export12/imscp_rootv1p1p2.xsd', $this->destDir) || !claro_copy_file('modules/learnPath/export12/imsmd_rootv1p2p1.xsd', $this->destDir) || !claro_copy_file('modules/learnPath/export12/adlcp_rootv1p2.xsd', $this->destDir)) {
            ...
            if ($this->fromScorm) {
                ...
                if (!claro_copy_file($this->srcDirScorm, $this->destDir) || !rename($this->destDir . '/path_' . $this->id, $this->destDir . '/OrigScorm')) {
        ...
        function createManifest() {
            global $langErrorCreatingManifest;
    ...
    <imsmd:lom>
        <imsmd:general>';
            ...
            function createFrameFile($fileName, $targetPath) {
                global $langErrorCreatingFrame, $charset, $langFrameOpens;
