    ...
    class ScormExport {
        ...
        function prepareQuiz($quizId, $raw_to_pass = 50) {
            global $langQuestion, $langSubmit, $langScore, $claro_stylesheet, $langError,
                    $clarolineRepositorySys, $charset, $langExerciseDone, $langSelect;
...
';
        ...
        function prepare() {
            ...
            if (
                    !make_dir($this->destDir) || !make_dir($this->destDir . "/common") || !make_dir($this->destDir . "/extend") || !make_dir($this->destDir . "/unique") || !make_dir($this->destDir . "/vocab")
            ) {
