                    ...
                    <div class='card-body'>
                        ...
                        <div class='form-group'>
                            ...
                            <div class='form-group mt-3'>
                                ...
                                <div class='col-sm-12'>
                                    <textarea id='homepage_intro' class='form-control' rows='3' cols='40' name='homepage_intro'>{{ $GLOBALS['homepage_intro'] }}</textarea>
                                </div>
                            </div>
                            ...
                            <div class='form-group mt-4'>
                                <div class='col-12 d-flex justify-content-between'>
                                    <input aria-label="{{ trans('langBack') }}" class='btn btn-primary' name='install4' value='&laquo; {{ trans('langBack') }}' type='submit'>
                                    <input aria-label="{{ trans('langContinue') }}" class='btn btn-primary' name='install6' value='{{ trans('langContinue') }} &raquo;' type='submit'>
                                </div>
                            </div>
